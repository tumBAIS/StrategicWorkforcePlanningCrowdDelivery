...
struct NPYArray1D {
    ...
    NPYArray1D(std::vector<double> _data) : shape(), data(_data) {};
...
struct NPYArray2D {
    ...
    std::vector<unsigned long> shape;
    std::vector<double> data;
    NPYArray2D(std::vector<unsigned long> _shape,std::vector<double> _data) : shape(_shape), data(_data) {};
...
struct NPYArray3D {
    ...
    std::vector<unsigned long> shape;
    std::vector<double> data;
    NPYArray3D(std::vector<unsigned long> _shape,std::vector<double> _data) : shape(_shape), data(_data) {};
...
struct NPYArray4D {
    ...
    std::vector<unsigned long> shape;
    std::vector<double> data;
    NPYArray4D(std::vector<unsigned long> _shape,std::vector<double> _data) : shape(_shape), data(_data) {};
...
// In case we need functions to save and load results
